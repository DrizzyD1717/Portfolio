...
const Approach = () => {
  return (
    <section className="w-full py-20">
      <h1 className="heading text-center text-2xl font-bold">
        My <span className="text-[#e49df3]">Approach</span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Planning & Strategy"
          icon={<AceternityIcon order="Phase 1" />}
          description="We will colaborate to map ot your website's goals, target audience, and key features. This phase involves research, brainstorming, and creating a detailed project plan."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Once we agree opn the plan, we will start designing the website's layout, user interface, and visual elements. I will keep you updated every step of the way to ensure the design aligns with your vision."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens! I will bring the design to life by writing clean, efficient code, building your website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
